    ...
    while True:
        ...
        if amount.isdigit():
            ...
            if amount>0:
                ...
                print("Amount deposited must be more than 0.")
        else:
...
def get_number_of_lines():
    while True:
        lines = input("Enter lines would you like to bet on (1-" + str(MAX_LINES) + ")")
        if lines.isdigit():
            lines = int(lines)
            if 1<= lines <=MAX_LINES:
                break
            else:
                print("Enter lines in range (1-"+ str(MAX_LINES)+")")
        else:
            print("Enter a number.")
    return lines
...
def main():
    ...
    while True:
        ...
        sp = input("Press enter to spin or press q to quit.")
        if sp == "q":
            break
